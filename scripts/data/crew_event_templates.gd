...
# === GRIEF TEXT (Phase 5.5) ===

const GRIEF_EVENTS: Array[String] = [
...
const GRIEF_RESOLVED_TEXT: String = "{name} is different now. The grief isn't gone — it never will be. But there's steel underneath it. They've decided that {deceased}'s death will mean something. And they'll make sure of it."
const GRIEF_BROKEN_TEXT: String = "{name} packs their bag slowly. They leave {deceased}'s favorite belonging on the bridge console before they go. They don't say goodbye to anyone."
const GRIEF_BROKEN_REQUEST: String = "{name} comes to you quietly. 'I can't be on this ship anymore, Captain. Everything here reminds me of them. I need to go somewhere they never were.'"

# === MOURNING TEXT (Phase 5.5) ===

const MOURNING_CREW: Array[String] = [
